...
"""
Script to train zebrafish phototaxis navigation model
"""
...
if SEPARATE:
    ...
    N_MIXED = 3
    N_CONV = 40
    chk_file = "./model_data/photo_separateInputModel.ckpt"
else:
    N_UNITS = 512
    N_BRANCH = 0
    N_MIXED = 3
    N_CONV = 40
    chk_file = "./model_data/photo_mixedInputModel.ckpt"
...
if __name__ == "__main__":
    ...
    with ZfGpNetworkModel() as Model:
        ...
        for epoch in range(N_EPOCHS):
            ...
            for tstep1 in range(epoch_size):
                # train on first data
