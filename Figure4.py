...
if __name__ == "__main__":
    ...
    # panel 6: Consequence of ablating all fish or non-fish types
    fig, ax = pl.subplots()
    sns.tsplot(trained, centers, n_boot=1000, condition="Trained", color="k")
    ...
    # panel 7: Retraining after ablating all fish types
    fig, ax = pl.subplots()
    ...
    # panel 8: Type fractions pre-ablation, post-ablation and after full re-training
